...
- SQL gotcha: column name `limit` is a SQL keyword; queries must quote it as `"limit"`.
...
- Use the runner action: `.\scripts\run_local.ps1 check-db` (PostgreSQL; SQLite was removed in programme 017).
