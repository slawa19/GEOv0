...
# --- p007_t715: caller-session isolation --------------------------------------
# (The announced SQLite money-precision limitation and its anti-vacuum control were tested here as
# well; both were SQLite-only - the first skipped itself on any other backend - and left with SQLite
