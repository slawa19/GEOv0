...
### Класс 2 из ревью среза (a) программы 023 (P2) — внесено 2026-09-26, получатель — 023, срез (a): дефект `(T)` замороженного раннера
