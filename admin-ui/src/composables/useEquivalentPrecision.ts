 ...
 * в диапазоне 0..8 (сужен с 0..18 2026-08-25, `012 / S1`: столько держит `Numeric(20, 8)`, и
 * ровно это объявляет протокол §3.2), и `seeds/equivalents.json` уже поставляет `HOUR` с `precision: 1` рядом с
