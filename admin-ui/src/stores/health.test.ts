...
/**
 * Транскрипция развилки экрана: `AppShell.vue:228` читает РОВНО одно поле стора,
 * `healthStore.error`, и при пустом значении уходит в `v-else` на `AppShell.vue:237-239`,
 * где стоит `<el-tag type="success">`. Ни `loading`, ни `health`, ни `migrations` в развилку
 * не входят. Ложь начинается здесь, а не в подписи тега.
 */
