export const EN: Record<string, string> = {
  ...
  'graph.keyboard.label': 'Open graph element',
  'graph.keyboard.placeholder': 'Choose a visible node or edge…',
  ...
  'graph.a11y.error': 'Network graph error: {error}',
  'graph.a11y.nodeSelected': 'Selected node {name}, PID {pid}.',
  'graph.a11y.nodeDetailsOpened': 'Selected node {name}, PID {pid}. Details opened.',
  'graph.a11y.edgeSelected': 'Selected edge from {from} to {to}, equivalent {equivalent}.',
  'graph.a11y.edgeDetailsOpened': 'Selected edge from {from} to {to}, equivalent {equivalent}. Details opened.',
  'graph.a11y.ready': 'Network graph ready with {nodes} nodes and {edges} edges.',
  ...
  'graph.analytics.activity.transactionsUnattributableTitle': 'Some transactions cannot be placed in these counters',
  'graph.analytics.activity.transactionsUnattributableDescription': 'The snapshot carries committed transactions that cannot be placed. Some publish no counterparties, so we cannot tell whether they involve this participant; some publish no equivalent, so we cannot tell whether they belong to the selected one. Only the cells such a row could belong to are withheld and shown as —; the counters still showing a number were reached without it.',
  ...
  'app.status.ok': 'ok',
  'app.status.unknown': 'health unknown',
