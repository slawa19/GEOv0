...
есть попарная сверка рёбер с историей, которая их породила. Это **не сделано** и принадлежит
программе 015. До тех пор состояние честное: проверки нет, и система об этом говорит.
