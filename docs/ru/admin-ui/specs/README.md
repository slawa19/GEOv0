...
Папка `docs/ru/admin-ui/specs/` — рабочие спецификации для развития админки.

## Активные (незавершённые)

- [docs/ru/admin-ui/specs/admin-ui-spec.md](admin-ui-spec.md)
...
Завершённые/зафиксированные спеки и гайды перенесены в `docs/ru/admin-ui/specs/archive/`:
