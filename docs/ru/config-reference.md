...
- Минимальная админка для управления параметрами: [`docs/ru/admin/specs/archive/admin-console-minimal-spec.md`](docs/ru/admin/specs/archive/admin-console-minimal-spec.md:1)
...
См. минимальную спецификацию админки: [`docs/ru/admin/specs/archive/admin-console-minimal-spec.md`](docs/ru/admin/specs/archive/admin-console-minimal-spec.md:1).
