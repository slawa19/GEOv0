...
писатели лимита доверия — затухание и понижение линии через simulator
trustline-update и `PATCH` кредитора — читают долг без блокировки строк и
корректны только потому, что `SERIALIZABLE`
