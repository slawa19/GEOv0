...
- `total_debt` — суммарный объём непогашенных обязательств в сети на момент бакета.
  ...
  - Это деньги: считается и хранится как `Decimal`/`NUMERIC(20, 8)`, на проводе —
    decimal string (007 / T715, 2026-08-20).

- `clearing_volume` — объём клиринга за интервал.
  - Единицы: сумма в выбранном эквиваленте.
  - Это деньги: `Decimal` от клирингового движка до колонки и до провода
    (007 / T715, 2026-08-20).
