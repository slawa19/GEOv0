...
## Гайд по прототипным скриншотам

- На основе каких документов и какие именно экраны/состояния нужно скриншотить (прототип функционала Этапа 1):
  - [SCREENSHOT-PROTOTYPE-GUIDE.md](SCREENSHOT-PROTOTYPE-GUIDE.md)
