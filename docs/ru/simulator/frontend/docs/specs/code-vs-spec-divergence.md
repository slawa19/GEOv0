...
**Обновление (2026-01-27):** раздел 6.3 в [GEO-visual-demo-fast-mock.md](GEO-visual-demo-fast-mock.md) синхронизирован с `vizMapping.ts`, текущих расхождений по значениям `link.width_px` / `link.alpha` больше нет. Ниже сохранена историческая справка о том, какие значения были в ранней версии спеки.
...
| intensity_key влияние на FX | При необходимости модуляции яркости |
