...
Каноническая таблица маппинга ключей → стили приведена в спеке: [specs/GEO-visual-demo-fast-mock.md](specs/GEO-visual-demo-fast-mock.md).

Кодовая реализация текущего маппинга: `simulator-ui/v2/src/vizMapping.ts`.
