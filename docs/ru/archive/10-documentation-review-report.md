...
- Управление параметрами из минимальной админки:
  - [`docs/ru/admin-ui/specs/archive/admin-console-minimal-spec.md`](docs/ru/admin-ui/specs/archive/admin-console-minimal-spec.md:1) включает `feature_flags.full_multipath_enabled` и `routing.*` как runtime‑mutable и подчёркивает важность `routing.max_paths_per_payment`.
...
- [`docs/ru/config-reference.md`](docs/ru/config-reference.md:1)
- [`docs/ru/admin-ui/specs/archive/admin-console-minimal-spec.md`](docs/ru/admin-ui/specs/archive/admin-console-minimal-spec.md:1)
